...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, START_MESSAGE, FORCE_SUB_TEXT, SUPPORT_CHAT, HOW_TO_POST_SHORT, ADMINS, DIRECT_GEN_DB
from utils import get_settings, get_size, is_subscribed, save_group_settings, temp, gen_link, clean_title, get_poster, temp, short_link
